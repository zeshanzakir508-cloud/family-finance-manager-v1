// lib/presentation/widgets/buttons/builders/segmented_button_style_builder.dart
...
/// Builder class for creating consistent segmented button styles.
///
/// This class constructs [ButtonStyle] objects for segmented buttons
/// based on the provided parameters, using centralized constants and helpers.
///
/// Example:
/// ```dart
/// final style = SegmentedButtonStyleBuilder.build(
///   context: context,
///   size: AppButtonSize.medium,
/// );
/// ```
abstract final class SegmentedButtonStyleBuilder {
  /// Builds a [ButtonStyle] for a segmented button with the given parameters.
  ///
  /// Parameters:
  ...
  ///
  /// Returns:
  ///   A [ButtonStyle] configured for a segmented button.
