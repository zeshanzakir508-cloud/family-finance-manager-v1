// lib/presentation/widgets/chips/app_choice_chip.dart
...
/// A choice chip for selecting one option from a group.
///
/// This widget provides a standardized choice chip that can be used
/// in a group where only one option can be selected at a time.
///
/// Example:
/// ```dart
/// AppChoiceChip(
...
///   onSelected: (value) => setState(() => selectedPeriod = 'weekly'),
/// )
/// ```
